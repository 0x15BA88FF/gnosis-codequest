...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    console.log('[Gnosis] POST', url, 'body:', { email: email.trim(), password: '***' });
    try {
      ...
      console.log('[Gnosis] login response:', response.status, response.statusText, 'url:', response.url);
